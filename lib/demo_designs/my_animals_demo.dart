...
import 'package:pet_lover/demo_designs/my_animals_menu_item_demo.dart';
...
class MyAnimalsDemo extends StatefulWidget {
  ...
  @override
  _MyAnimalsDemoState createState() => _MyAnimalsDemoState(
      profileImageLink,
      username,
      mobile,
      date,
...
class _MyAnimalsDemoState extends State<MyAnimalsDemo> {
  String profileImageLink;
  String username;
  String mobile;
  String date;
  ...
  _showDeleteToast(BuildContext context) {
    final scaffold = ScaffoldMessenger.of(context);
    scaffold.showSnackBar(
      SnackBar(
        content: Text('$petName has been deleted successfully.'),
      ),
    );
  }
